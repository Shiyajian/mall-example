 ...
 */
@Component
public class WechatCallbackHandler extends ChannelCallbackHandler {
     ...
     */
    @Override
    protected boolean isIgnore(Throwable throwable) {
     ...
     */
    @Override
    protected ResponseEntity<String> failed(Throwable e) {
